...
var BullMQConnection = class _BullMQConnection {
  ...
  sharedClient;
  /** Scoped logger. */
  logger = new Logger(_BullMQConnection.name);
...
BullMQConnector = __decorateClass([
  Injectable()
], BullMQConnector);
...
export { BullMQConnection, BullMQConnector, NESTJS_QUEUE_MODULE_OPTIONS, QueueModule, QueueService };
